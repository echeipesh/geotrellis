...
class Z3(val z: Long) extends AnyVal {
  ...
  override def toString = f"$z%6s ${decode}"
}
...
object Z3 {
 ...
 /** combine very third bit to form a value. Maximum value is 21 bits. */
  ...
  def zranges(min: Z3, max: Z3): Seq[(Long, Long)] = {
    ...
    //TODO: Maybe this needs to be generic on return type an take (Long, Long) => T
    var prefix: Long = 0
