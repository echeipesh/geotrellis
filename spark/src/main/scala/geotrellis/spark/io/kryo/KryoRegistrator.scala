...
class KryoRegistrator extends SparkKryoRegistrator {
  ...
  override def registerClasses(kryo: Kryo) {
    ...
    kryo.register(classOf[geotrellis.raster.summary.polygonal.visitors.MaxVisitor.TileMaxVisitor])
    kryo.register(classOf[geotrellis.raster.summary.polygonal.visitors.MaxVisitor.MultibandTileMaxVisitor])
    ...
    kryo.register(geotrellis.tiling.EmptyBounds.getClass)
